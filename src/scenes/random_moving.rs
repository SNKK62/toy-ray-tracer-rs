use crate::hittable::{BvhNode, HittableKey, HittableStruct, MovingSphere, Sphere};
        ...
        for b in -11..11 {
            ...
            if (center - Point3::new(4.0, radius, 0.0)).len() > 0.9 {
                ...
                if choose_mat < 0.7 {
                    ...
                    let mut sphere = HittableStruct::new(HittableKey::MovingSphere);
                    sphere.moving_sphere = Some(MovingSphere::new(
                        &center,
                        &center2,
                        radius,
                        sphere_material,
